data "aws_iam_policy_document" "analysis_vehicle_basic_data" {
...
module "lambda_analysis_vehicle_basic_data" {
  source        = "../modules/lambda"
  name          = "${var.project}-analysis-vehicle-basic-data"
  source_bucket = module.global_variables.source_bucket
  project       = var.project
  policy_json   = data.aws_iam_policy_document.analysis_vehicle_basic_data.json
  handler       = "src/controllers/${var.project}/send-request-analysis/vehicle/basic-data/index.handler"
