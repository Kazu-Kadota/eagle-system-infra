data "aws_iam_policy_document" "worker_techmize_new_v1_answer_analysis_person_cnh" {
  ...
  statement {
    ...
    resources = [
      aws_sfn_state_machine.sfn_techmize_new_v1_person_cnh_basic.arn
    ]
  }
...
module "lambda_worker_techmize_new_v1_answer_analysis_person_cnh" {
  source        = "../modules/lambda"
  name          = "${var.project}-worker-answer-analysis-person-cnh"
  source_bucket = module.global_variables.source_bucket
  project       = var.project
  policy_json   = data.aws_iam_policy_document.worker_techmize_new_v1_answer_analysis_person_cnh.json
  handler       = "src/worker/techmize/new-v1/answer-analysis/person/cnh/index.handler"
  timeout       = 20
...
# resource "aws_lambda_event_source_mapping" "lambda_worker_techmize_new_v1_answer_analysis_person_cnh" {
#   event_source_arn = aws_sqs_queue.eaglerequest_techmize_new_v1_answer_analysis_person_cnh_basic.arn
#   function_name    = module.lambda_worker_techmize_new_v1_answer_analysis_person_cnh.arn
#   batch_size       = 1
# }
