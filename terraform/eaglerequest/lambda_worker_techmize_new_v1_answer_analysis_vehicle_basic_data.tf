data "aws_iam_policy_document" "worker_techmize_new_v1_answer_analysis_vehicle_basic_data" {
  ...
  statement {
    ...
    resources = [
      aws_sfn_state_machine.sfn_techmize_new_v1_vehicle_basic_data.arn
    ]
  }
...
module "lambda_worker_techmize_new_v1_answer_analysis_vehicle_basic_data" {
  source        = "../modules/lambda"
  name          = "${var.project}-worker-answer-analysis-vehicle-basic-data"
  source_bucket = module.global_variables.source_bucket
  project       = var.project
  policy_json   = data.aws_iam_policy_document.worker_techmize_new_v1_answer_analysis_vehicle_basic_data.json
  handler       = "src/worker/techmize/new-v1/answer-analysis/vehicle/basic-data/index.handler"
  timeout       = 20
...
# resource "aws_lambda_event_source_mapping" "lambda_worker_techmize_new_v1_answer_analysis_vehicle_basic_data" {
#   event_source_arn = aws_sqs_queue.eaglerequest_techmize_new_v1_answer_analysis_vehicle_basic_data.arn
#   function_name    = module.lambda_worker_techmize_new_v1_answer_analysis_vehicle_basic_data.arn
#   batch_size       = 1
# }
